...
typedef NS_ENUM(NSUInteger, FLEXGlobalsRow) {
    ...
    FLEXGlobalsRowLeakDetect,
    FLEXGlobalsRowDetectImages,
    FLEXGlobalsRowDetectViews,
    FLEXGlobalsRowDetectViewController,
    FLEXGlobalsRowCount
};
    ...
    for (FLEXGlobalsRow defaultRowIndex = 0; defaultRowIndex < FLEXGlobalsRowCount; defaultRowIndex++) {
        ...
        switch (defaultRowIndex) {
            ...
            case FLEXGlobalsRowNetworkHistory:
                ...
                break;
            case FLEXGlobalsRowLeakDetect:
                titleFuture = ^{
                    return @"📡  Leak Detect";
                };
                viewControllerFuture = ^{
                    return [[FLEXLeakDetectViewController alloc] init];
                };
                break;
            case FLEXGlobalsRowDetectImages:
                titleFuture = ^{
                    return @"📡  Images Detect";
                };
                viewControllerFuture = ^{
                    return [[FLEXDetectImagesTableViewController alloc] init];
                };

                break;
            case FLEXGlobalsRowDetectViews:
                titleFuture = ^{
                    return @"📡  views Detect";
                };
                viewControllerFuture = ^{
                    return [[FLEXDetectViewsTableViewController alloc] init];
                };
                
                break;
            case FLEXGlobalsRowDetectViewController:
                titleFuture = ^{
                    return @"📡  ViewController Detect";
                };
                viewControllerFuture = ^{
                    return [[FLEXDetectViewControllerTableViewController alloc] init];
                };
