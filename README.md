从FLEX2.1.1fork 下来，支持ios7以上。主要添加LeakDetect文件夹
比原有功能多4个 自定义的leakdetect、images detect、views detect和viewcontroller detect


//TODO view detect需要增加对drawRect 检测，leakdetect需要支持分类
